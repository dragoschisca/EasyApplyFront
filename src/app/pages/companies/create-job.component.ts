...
@Component({
  ...
  template: `
    <div
      class="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 font-sans pb-12"
    >
      <div class="flex items-center gap-4">
        <a
          routerLink="/company-jobs"
          class="p-2 bg-white rounded-xl shadow-sm border border-gray-100 hover:bg-gray-50 text-gray-500 transition-colors"
        >
          <svg
            class="w-5 h-5"
            fill="none"
      ...
      >
        <div class="p-8 space-y-8">
          ...
          <div class="space-y-6">
            <h3
              class="text-xl font-bold text-gray-800 border-b border-gray-100 pb-2"
            >
              Basic Details
            </h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2"
                  >Detailed Address (for Map)</label
                >
                <input
                  type="text"
                  formControlName="address"
                  placeholder="e.g. Chisinau, bd. Moscova 5/1"
                  class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all"
                />
              </div>
              <div>
                ...
                <select
                  ...
                  class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all bg-white appearance-none"
                >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                >
                  ...
                  <option value="MediumExperience">
                    Mid-Level / Medium Exp
                  </option>
              ...
              <div>
                ...
                >
                  ...
                  <option [value]="1">On-site (Local)</option>
          ...
          <div class="space-y-6 pt-6">
            ...
            <div>
              ...
              <textarea
                ...
                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all resize-y"
              ></textarea>
            </div>
        ...
        <div
          class="bg-gray-50 border-t border-gray-100 p-8 flex items-center justify-between"
        >
          <button
            type="button"
            routerLink="/company-jobs"
            class="text-gray-500 hover:text-gray-800 font-bold py-3 px-6 transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            class="bg-purple-600 text-white font-bold py-3 px-10 rounded-xl shadow-lg shadow-purple-200 hover:bg-purple-700 transition-all active:scale-95 disabled:opacity-50 flex items-center"
          >
            <span *ngIf="isSaving" class="mr-2 animate-spin"
